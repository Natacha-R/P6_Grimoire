...
module.exports = (req, res, next) => {
  ...
  try {
    ...
    const decodedToken = jwt.verify(token, "RANDOM_TOKEN_SECRET"); // Vérifie et décode le token pour vérifier qu'il n'a pas été altéré et qu'il est valide (jeton + clé secrète)
    req.auth = {
